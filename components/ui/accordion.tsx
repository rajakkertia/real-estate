...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between gap-4 py-6 text-left text-base font-medium text-foreground transition-all hover:text-forest-700 [&[data-state=open]>svg]:rotate-180",
        className,
      )}
      {...props}
    >
